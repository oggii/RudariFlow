...
const en: Translations = {
  ...
  dictionary_desc: "Words Whisper should know: names, brands and jargon. They are also written exactly like this in your text.",
...
const de: Translations = {
  ...
  dictionary_desc: "Wörter, die Whisper kennen soll: Namen, Marken und Fachbegriffe. Im Text werden sie auch genau so geschrieben.",
