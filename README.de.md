...
> **v0.2.0 — Windows.** NVIDIA-GPU für Beschleunigung empfohlen, CPU-Fallback für AMD/Intel/no-GPU. Mac/Linux folgen.

Made by [oggi](https://0ggi.ch).

## Features

- Lokale Transkription via whisper.cpp — keine Cloud nötig
...
# 3. whisper.cpp Backends herunterladen (cuBLAS + CPU, ~600 MB total)
